...
3	NEXT	Play Next
4	LIVE	Live
5	ADDSTOH	ADDS - Advertising Top Of Hour
6	ADDSDRIVETIME	ADDS - Advertising Drive Time
7	ADDS	ADDS - Advertising
8	TOP40	Top 40 MUSIC
9	ROOTS	Roots MUSIC
10	MUSIC	Music Library
11	FILLTOTOH	Fill To TOH Schedule
12	NWS	News Weather Sports
\.
...
SELECT pg_catalog.setval('public.categories_rowid_seq', 12, true);
